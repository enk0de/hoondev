    ...
    <div className="project_container">
      ...
      <div className="caption_container">
        <div className="caption_title caption_item">
          <b>풀스택 개발자</b>라는 목표를 향해
          <br />
          즐거운 마음으로 <b>경험</b>을 쌓는 중입니다.
        </div>
      </div>
      ...
      <div className="content_container" id="rtcorona">
        <div className="content_item">
          ...
          <p>
            ...
            Firebase GCP를 통해 라이브 서비스 중에 있습니다.
          </p>
          <a
      ...
      <div className="content_container" id="recordingios">
        <div className="content_item">
          ...
          <p>
            ...
            느꼈습니다. 그래서 녹음과 음원 재생을 함께할 수 있는 기능을 가진
            녹음 앱을 만들고 싶었고, 한 달 동안 매일 4~5시간 씩 개발에 매진하여
            앱을 개발하였습니다. iOS/Swift 공식문서와 stackoverflow의 도움을
            받아 AVFoundation 프레임워크에 있는 오디오를 다루는 다양한
            라이브러리를 이용해 앱을 완성할 수 있었습니다.
          </p>
          <a
            style={{ marginRight: '10px', marginBottom: '10px' }}
